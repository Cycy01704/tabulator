...
<div class="max-w-3xl mx-auto space-y-10">
    <div class="flex items-center space-x-6">
        ...
        <div>
            <h1 class="text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">Register Judge</h1>
            <p class="text-slate-500 font-medium">Create credentials for a new evaluator.</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden">
        <form action="{{ route('judges.store') }}" method="POST" class="p-10 space-y-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-3">
                    <label for="password" class="block text-sm font-bold text-slate-700 dark:text-slate-300 ml-1 uppercase tracking-widest">Security Pin</label>
